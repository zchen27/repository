...
public class ListManagerActor extends UntypedActor
{
	...
	public void onReceive(Object msg) throws Exception
	{
		...
		else if (msg instanceof ImportListRequestMessage)
		{
			...
			Props delegateProps = ImportListProcessingActor.props(list,
					getSelf(), getSender());
		...
		else if (msg instanceof MapRequestMessage)
		{
			...
			Props mapProps = MapProcessingActor.props(getSelf(), getSender(),
					payload);
		...
		{
			System.out.printf("Bad message to ListManagerActor:  %s%n",
					msg.toString());
