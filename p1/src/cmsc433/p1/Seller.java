...
public class Seller implements Client
{
	...
	public Seller(AuctionServer server, String name, int cycles,
	...
	public void run()
	{
		for (int i = 0; i < this.cycles && this.items.size() > 0; ++i)
		{
			...
			int listingID = server.submitItem(this.name(), item,
					this.rand.nextInt(100), this.rand.nextInt(100) + 100);
