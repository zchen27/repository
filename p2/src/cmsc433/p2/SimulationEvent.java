...
public class SimulationEvent
{
	...
	private SimulationEvent(EventType event, Cook cook, Customer customer,
			Machine machine, Food food, List<Food> orderFood, int orderNumber,
			int[] simParams)
	{
		this.event = event;
		this.cook = cook;
	...
	public static SimulationEvent startSimulation(int numCustomers,
			int numCooks, int numTables, int capacity)
	{
		...
		params[2] = numTables;
		params[3] = capacity;
		return new SimulationEvent(EventType.SimulationStarting, null, null,
				null, null, null, 0, params);
	}

	public static SimulationEvent endSimulation()
	{
		return new SimulationEvent(EventType.SimulationEnded, null, null, null,
				null, null, 0, null);
	}
	...
	{
		return new SimulationEvent(EventType.CustomerStarting, null, customer,
	...
	public static SimulationEvent customerPlacedOrder(Customer customer,
			List<Food> order, int orderNumber)
	{
		return new SimulationEvent(EventType.CustomerPlacedOrder, null,
				customer, null, null, order, orderNumber, null);
	}
	...
	{
		return new SimulationEvent(EventType.CookStarting, cook, null, null,
				null, null, 0, null);
	}

	public static SimulationEvent cookReceivedOrder(Cook cook, List<Food> order,
			int orderNumber)
	{
		return new SimulationEvent(EventType.CookReceivedOrder, cook, null,
				null, null, order, orderNumber, null);
	}

	public static SimulationEvent cookStartedFood(Cook cook, Food food,
			int orderNumber)
	{
		return new SimulationEvent(EventType.CookStartedFood, cook, null, null,
				food, null, orderNumber, null);
	}

	public static SimulationEvent cookFinishedFood(Cook cook, Food food,
			int orderNumber)
	{
		return new SimulationEvent(EventType.CookFinishedFood, cook, null, null,
				food, null, orderNumber, null);
	}

	public static SimulationEvent cookCompletedOrder(Cook cook, int orderNumber)
	{
		return new SimulationEvent(EventType.CookCompletedOrder, cook, null,
				null, null, null, orderNumber, null);
	}

	public static SimulationEvent cookEnding(Cook cook)
	{
		return new SimulationEvent(EventType.CookEnding, cook, null, null, null,
				null, 0, null);
	}

	/* Machine events */
	public static SimulationEvent machineStarting(Machine machine, Food food,
			int capacity)
	{
		int[] params = new int[1];
		params[0] = capacity;
		return new SimulationEvent(EventType.MachineStarting, null, null,
				machine, food, null, 0, params);
	}

	public static SimulationEvent machineCookingFood(Machine machine, Food food)
	{
		return new SimulationEvent(EventType.MachineStartingFood, null, null,
				machine, food, null, 0, null);
	}

	public static SimulationEvent machineDoneFood(Machine machine, Food food)
	{
		return new SimulationEvent(EventType.MachineDoneFood, null, null,
				machine, food, null, 0, null);
	}

	public static SimulationEvent machineEnding(Machine machine)
	{
		return new SimulationEvent(EventType.MachineEnding, null, null, machine,
				null, null, 0, null);
	}
	...
	public String toString()
	{
		switch (event)
		{
			...
			case CustomerPlacedOrder:
				return customer + " placing order " + orderNumber + " "
						+ orderFood;

			case CustomerReceivedOrder:
				return customer + " received order " + orderNumber + " "
						+ orderFood;
			...
			case CookReceivedOrder:
				return cook + " starting order " + orderNumber + " "
						+ orderFood;

			case CookStartedFood:
				return cook + " preparing " + food + " for order "
						+ orderNumber;
			...
			case MachineStarting:
				return machine + " starting up for making " + food + "; "
						+ simParams[0] + ".";
