...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		System.out.printf("nil is %s ([]); reference count is %d (0)%n",
		...
		System.out.printf(
				"Tail for list3 is %s ([]); reference count for tail is %d (2)%n",
				lops.exportList(tailList3), lops.getReferenceCount(tailList3));
		System.out.printf("Reference count for nil is %d (2)%n",
				lops.getReferenceCount(nil));
		...
		//System.out.printf(
		//		"Reference count for list is %d%n, for nil is %d (THIS SHOULD NOT BE HERE!)%n",
		//		lops.getReferenceCount(list3), lops.getReferenceCount(nil));

		// Get head value. "3" should be printed.
		System.out.printf("Head of list3 is %d (3)%n", lops.head(list3));
		...
		System.out.printf("List23 is %s ([2,3])%n", lops.exportList(list23));
		System.out.printf(
				"Reference count for list23 is %d (0); reference count for list3 is %d (1)%n",
		...
		System.out.printf(
				"Head of list 23 is %s (2); tail of list23 is %s ([3])%n",
				lops.head(list23), lops.exportList(lops.tail(list23)));
		System.out.printf("Reference count for list3 is %d (2)%n",
		...
		System.out.printf("Exported list123 is %s ([1,2,3])%n",
				lops.exportList(list123));
		System.out.printf("Reference count for list123 is %d (0)%n",
				lops.getReferenceCount(list123));
		System.out.printf("Reference count for tail(list123) is %d (2)%n",
		...
		System.out.printf("Reference count of tail(mappedList3) is %d (2)%n",
		...
		System.out.printf("Reference count of tail(list3) is %d (2)%n",
				lops.getReferenceCount(lops.tail(list3)));

		// Now try sum. "0" and "6" should be printed.

		System.out.printf("The sum of nil is %d (0)%n", lops.sum(nil));
		System.out.printf("The sum of list123 is %d (6)%n", lops.sum(list123));
		...
		System.out.printf("The reference count for tail(list123) is %d (3)%n",
				lops.getReferenceCount(lops.tail(list123)));
